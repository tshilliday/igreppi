<!DOCTYPE html>
    <html <?php language_attributes(); ?> prefix="og: http://ogp.me/ns#">
        <head>
            ...
            <link rel="apple-touch-icon" sizes="144x144" href="<?php bloginfo('template_url'); ?>/favicon/apple-touch-icon.png">
            ...
            <link rel="mask-icon" href="<?php bloginfo('template_url'); ?>/favicon/safari-pinned-tab.svg" color="#1ba5b9">
            <link rel="shortcut icon" href="<?php bloginfo('template_url'); ?>/favicon/favicon.ico">
            <meta name="msapplication-TileColor" content="#1ba5b9">
            <meta name="msapplication-config" content="<?php bloginfo('template_url'); ?>/favicon/browserconfig.xml">
            <meta name="theme-color" content="#ffffff">

            <?php wp_head(); ?>
            <link href="<?php bloginfo('template_url'); ?>/fonts/fontawesome-pro-5.4.2-web/css/all.min.css" rel="stylesheet">
            <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/dist/css/vendor.css?ver=<?php echo wp_get_theme()->get('Version'); ?>">
            <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/dist/css/main.css?ver=<?php echo wp_get_theme()->get('Version'); ?>">

        </head>

        <?php
        $menu_background_image = get_field('menu_background_image', 'website-settings');
        $nav_bg_html = "";
        if ($menu_background_image) {
            $menu_background_src = wp_get_attachment_image_src($menu_background_image, 'menu_background')[0];
            $nav_bg_html = "style='background-image: url(".$menu_background_src.")'";
        }
        ?>
                ...
                <header class="header float show">
                    <div class="header__logo">
                        <a href="<?php echo esc_url(home_url('/')); ?>">
                            <picture>
                                <svg xmlns="http://www.w3.org/2000/svg" width="201.037" height="106.024" viewBox="0 0 201.037 106.024">
                    ...
                    <div class="menu-button js menu-button--left">
                    ...
                    <nav class="nav js" <?php echo $nav_bg_html; ?>>
                        <div class="nav__inner">
                            <div class="c">
                                <div class="r">
                                    <div class="c-md-4 l-c-md-o-2">
                                        <?php
                                    ...
                                    <div class="c-md-6">
                                        <h4 class="hide-lt-menu info">Address</h4>
                                        <div class="hide-lt-menu">
                                            <address>
                                            ...
                                            <?php endif; ?>
                                            <?php echo get_button_html(get_page_link_by_template('page-templates/contact.php') . '#contact', 'Message', null, 'button button--white'); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
